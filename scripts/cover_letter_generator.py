...
st.markdown("Upload your resume (PDF) + paste the job description → get a tailored cover letter.")
...
st.markdown("---")
st.caption(
    "Powered by Groq (llama-3.3-70b-versatile) • Always review & personalize the output"
)
